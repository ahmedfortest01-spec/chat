  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-2">
        <label htmlFor="name" className="text-sm font-medium text-slate-600 dark:text-slate-300 block">{t('fullName')}</label>
        <input
          id="name"
          name="name"
          type="text"
      ...
      <div className="space-y-2">
        <label htmlFor="username" className="text-sm font-medium text-slate-600 dark:text-slate-300 block">{t('username')}</label>
        <input
          id="username"
          name="username"
          type="text"
